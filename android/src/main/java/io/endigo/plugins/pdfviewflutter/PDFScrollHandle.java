...
public class PDFScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    // 滚动条显示接口对象
    protected ScrollHandlerNotify scrollHandlerNotify;
    ...
    public PDFScrollHandle(Context context, ScrollHandlerNotify handlerNotify) {
        super(context);
        this.scrollHandlerNotify = handlerNotify;
    ...
    public void show() {
        ...
        if(scrollHandlerNotify != null){
            scrollHandlerNotify.onScrollHandlerChanged(true);
        }
    }
    ...
    public void hide() {
        setVisibility(INVISIBLE);
        if(scrollHandlerNotify != null){
            scrollHandlerNotify.onScrollHandlerChanged(false);
        }
    }
