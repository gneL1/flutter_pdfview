...
typedef ScrollHandlerChangedCallback = void Function(bool? enable);
...
class PDFView extends StatefulWidget {
  ...
  final ScrollHandlerChangedCallback? onScrollHandlerChanged;
...
class PDFViewController {
  ...
  Future<bool?> _onMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'onScrollHandlerChanged':
        if (_widget.onScrollHandlerChanged != null) {
          _widget.onScrollHandlerChanged!(call.arguments['enable']);
        }
